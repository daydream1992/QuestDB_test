...
_SCORE_MIN = 80.0          # 共振总分阈，保守
_STOCK_CHANGE_MIN = 3.0    # 个股涨幅阈值，保守
    ...
    def evaluate(self, ctx) -> List[Decision]:
        ...
        if pv is not None and not pv.empty:
            ...
            for _, r in pv_l.iterrows():
                ...
                price_map[r['code']] = _safe_float(r.get('Now'))  # P0-A3 修复: 存 price
        ...
        for _, r in df.iterrows():
            ...
            decisions.append(Decision(
                ...
                price=price_map.get(code, 0), score=score,  # P0-A3 修复: 用 price_map
            ))
        return decisions
