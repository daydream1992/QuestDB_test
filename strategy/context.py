...
class StrategyContext:
    ...
    intraday_df: Optional[pd.DataFrame] = None       # 个股intraday (qd_stock_intraday, c3 拆出, 原始保留)
    gp_df: Optional[pd.DataFrame] = None             # 个股GP交易数据 (qd_stock_gpjy, 日级: 连板率/次日红盘率/机构等)
