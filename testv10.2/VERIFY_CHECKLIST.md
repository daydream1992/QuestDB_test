...
**2026-08-10 盘中实测记录 (09:15-12:00 上午 + 12:25 暂停重启):**

**✅ 已验证:**
- 竞价门控进 auction (09:19/09:22/09:24 三轮跑了)
- 全市场补钻 (钻取 143→187→221 股含池外)
- 情绪表 1min / 个股榜 / 轮动表 写表
- 新主线/趋势确认/龙头封板推送 (55 次) + 竞价定调/龙头涨停预测卡 (9:25)
- 涨停梯队表写表

**❌ 未验证/失败:**
- **开盘段 subscribe_hq 失败** (通达信 DLL 订阅通道异常, 9:30-9:45 无回调, 今日 3699 次 ERROR) → 开盘拉升/盲区补盲链废
- **跳水预警未触发** (且 lane1 曾被子级炸板事件挤占, 已修优先级)
- **close 定格 15:00 未跑到** (10:17 暂停重启)
- **尾盘段 14:00-15:00 未跑到**
- 竞价期 COM 卡死 (9:15-9:25 OpenAmo 取到 0 → 金额 0亿)

**新发现问题 (已修):**
- 午休 11:30-13:00 还跑还推 (STAGE_RANGES 拆段修复)
- 新主线 28 次/天骚扰 (已收紧 score≥50+涨停≥2)
- 同股反复炸-回刷屏 (已限 2 次)

**下午待验证 (13:00-15:00):**
- 尾盘段 14:00: tail 炸板 + 高低切 + 板块梯队继续
- close 定格 15:00: force_push + 尾盘 flush + 退出
- 新频控: 优先级/限次/收紧效果
